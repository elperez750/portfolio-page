...
function About() {
  return (
    <div id="about" className="bg-gradient-to-r from-black to-blue h-full">
      <div className="flex flex-col md:flex-row justify-between items-center text-gray pl-10 text-center pb-20">
        ...
        <div className="flex flex-col justify-end mt-28 pl-5 pr-5 ">
          <h1 className="text-center mb-4 font-futura_bold text-gray text-5xl ">
            Current skills
          </h1>
          <div>
            <SkillsList />
